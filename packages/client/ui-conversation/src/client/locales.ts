...
export const zh = {
  ...
  'message.modelMetadata': '本条回复使用的模型与推理强度',
  'message.effort.low': '低',
  'message.effort.medium': '中',
  'message.effort.high': '高',
  'message.effort.xhigh': '极高',
...
export const en = {
  ...
  'message.tokensPerSecond': '{tps} tok/s',
  'message.modelMetadata': 'Model and reasoning effort used for this reply',
  'message.effort.low': 'Low',
  'message.effort.medium': 'Medium',
  'message.effort.high': 'High',
  'message.effort.xhigh': 'Very high',
